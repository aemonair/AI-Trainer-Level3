...
| 章节 | 题目数 | 核心考点 |
|------|--------|----------|
| 1.1.1 | 4 | apply, groupby, np.where, pd.cut, read_csv, value_counts |
| 1.1.2 | 4 | agg, drop, fillna, groupby, isin, np.where, read_csv, sum |
| 1.1.3 | 3 | between, drop, isnull, score, sum, to_csv |
| 1.1.4 | 3 | astype, between, drop, dropna, groupby, head, read_csv, to_csv |
| 1.1.5 | 3 | agg, astype, between, drop, dropna, groupby, head, pd.cut |
| 2.1.1 | 1 | StandardScaler, drop, dropna, fit, fit_transform, head, isnull, read_csv |
| 2.1.2 | 1 | StandardScaler, drop, dropna, fit, fit_transform, head, to_csv, train_test_split |
| 2.1.3 | 1 | MinMaxScaler, drop, fit, fit_transform, head, read_csv, sum, to_csv |
| 2.1.4 | 1 | MinMaxScaler, drop, fit, fit_transform, groupby, head, isnull, read_csv |
| 2.1.5 | 1 | LabelEncoder, apply, astype, drop, dropna, fillna, fit, fit_transform |
| 2.2.1 | 1 | LogisticRegression, classification_report, drop, fit, head, predict, read_csv, to_csv |
| 2.2.2 | 1 | StandardScaler, drop, dropna, fit, head, predict, read_csv, score |
| 2.2.3 | 1 | apply, fit, head, isin, predict, read_csv, score, to_csv |
| 2.2.4 | 1 | drop, fit, head, predict, score, to_csv, train_test_split |
| 2.2.5 | 1 | fit, head, predict, read_csv, score, to_csv, train_test_split |
| 3.2.1 | 1 | Image.open, argsort, astype, ort.InferenceSession, predict, softmax |
| 3.2.2 | 1 | Image.open, predict |
| 3.2.3 | 1 | Image.open, ort.InferenceSession, predict |
| 3.2.4 | 1 | Image.open, astype, ort.InferenceSession, predict, softmax |
| 3.2.5 | 1 | astype, ort.InferenceSession, predict, sum |
...
### 题目2：创建新列'RiskLevel'，根据住院天数判断风险等级 3分
...
### 题目2：对传感器类型进行分组，并计算每个组的数据数量和平均值 3分
...
### 题目3：筛选出温度和湿度数据，然后按位置和传感器类型分组，计算每个组的平均值 2分
...
### 题目1：从标签文件中读取每一行，并去除行首尾的空白字符，得到类别名称列表 2分
